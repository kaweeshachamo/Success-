...
re-edited by Mr chaby
re-edited by virus fucker
*/
...
if (Config.WORKTYPE == 'private') {
    ...
    Stefanie.addCommand({pattern: 'sysd', fromMe: true, desc: Lang.SYSD_DESC}, (async (message, match) => {
   ...
   Stefanie.addCommand({pattern: 'live', fromMe: false, desc: Lang.ALIVE_DESC}, (async (message, match) => {
...
var i = Math.floor(31*Math.random())
    ...
    Stefanie.addCommand({pattern: 'sysd', fromMe: false, desc: Lang.SYSD_DESC}, (async (message, match) => {
    ...
    Stefanie.addCommand({pattern: 'psysd', fromMe: true, desc: Lang.SYSD_DESC, dontAddCommandList: true }, (async (message, match) => {
